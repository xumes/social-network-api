...
func UpdateUserById(w http.ResponseWriter, r *http.Request) {
	...
	if userId != tokenUserId {
		responses.Error(w, http.StatusForbidden, errors.New("you can only edit your own user"))
		return
	}
...
func RemoveUserById(w http.ResponseWriter, r *http.Request) {
	...
	if userId != tokenUserId {
		responses.Error(w, http.StatusForbidden, errors.New("you can only delete your own user"))
		return
	}
...
func UpdatePassword(w http.ResponseWriter, r *http.Request) {
	...
	if userId != tokenUserId {
		responses.Error(w, http.StatusForbidden, errors.New("it is not possible update the password from another user"))
		return
	}
	...
	repository := repositories.NewUserRepository(db)
	hashedPassword, err := repository.GetPasswordById(userId)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}

	if err = security.ComparePassword(hashedPassword, password.Current); err != nil {
		responses.Error(w, http.StatusUnauthorized, err)
		return
	}
